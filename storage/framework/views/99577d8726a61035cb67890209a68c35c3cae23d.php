...
<?php $__env->startSection('title', 'Home - Online BookStore'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero-section text-center">
        <div class="container">
            ...
            <a href="<?php echo e(route('books.index')); ?>" class="btn btn-primary btn-lg">Browse Collection</a>
            <a href="<?php echo e(route('sell')); ?>" class="btn btn-outline-light btn-lg">Sell Your Books</a>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-3 col-6 mb-4">
                    <div class="stat-number text-primary h2 fw-bold"><?php echo e($totalBooks); ?></div>
                    <div class="stat-label text-muted">Books Available</div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stat-number text-primary h2 fw-bold"><?php echo e($totalGenres); ?></div>
                    <div class="stat-label text-muted">Genres</div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stat-number text-primary h2 fw-bold"><?php echo e($totalAuthors); ?></div>
                    <div class="stat-label text-muted">Authors</div>
                </div>
                <div class="col-md-3 col-6 mb-4">
                    <div class="stat-number text-primary h2 fw-bold"><?php echo e($soldBooks); ?></div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\kumar\OneDrive - Chandigarh University\Desktop\lerval\Book\resources\views/home.blade.php ENDPATH**/ ?>